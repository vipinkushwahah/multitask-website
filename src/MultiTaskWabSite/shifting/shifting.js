...
const Shifting = () => {
  ...
  let Info = [
      {name:"shivam",address:"Lucknow Utter Pradesh",Service1:"House Shifting",categery:"Shifting",image:"./logo512.png",number:"7920340897",image1:"./ffff.PNG",image2:"./form.PNG",image3:"./countdown.png",image4:"./Capture5.PNG",email:"vipinkushwaha902@gmail.com"}
  ]

  let Info2 = [
      {name:"arvind kumar",address:"gkp",Service1:"Washing machine Shifting",categery:"Shifting",email:"arvind@gmail.com",number:"7907345807",image:"./logo512.png",image1:"./ffff.PNG",image2:"./form.PNG",image3:"./countdown.png",image4:"./Capture5.PNG"}
  ]
  
  let Info3 = [
      {name:"rajeev kumar",address:"bhatava",Service1:"Bathroom Shifting",categery:"Shifting",email:"rajeev@gmail.com",number:"7927045890",image:"./logo512.png",image1:"./ffff.PNG",image2:"./form.PNG",image3:"./countdown.png",image4:"./Capture5.PNG"}
  ]

  let Info4 = [
      {name:"abhishek kumar",address:"mirava bazar",Service1:"Kichan Shifting",categery:"Shifting",email:"abhishek@gmail.com",number:"7927345897",image:"./logo512.png",image1:"./ffff.PNG",image2:"./form.PNG",image3:"./countdown.png",image4:"./Capture5.PNG"}
  ]

  let Info5 = [
      {name:"lucky kumar",address:"padaruna",Service1:"toilet Shifting",categery:"Shifting",email:"lucky@gmail.com",number:"7927346392",image:"./logo512.png",image1:"./ffff.PNG",image2:"./form.PNG",image3:"./countdown.png",image4:"./Capture5.PNG"}
  ]

  let Info6 = [
      {name:"sujeet kumar",address:"samalganj",Service1:"basment Shifting",categery:"Shifting",email:"sujeet@gmail.com",number:"7420868346",image:"./logo512.png",image1:"./ffff.PNG",image2:"./form.PNG",image3:"./countdown.png",image4:"./Capture5.PNG"}
  ]
  ...
  return openDetailsPage ? (
    ...
    <div className="flex md:mt-[60px] md:ml-[40px] mb-[40px]">
    <div>
     <Naavbar/>
    </div>
    <div>
